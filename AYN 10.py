...
covid_news_label = tk.Label(frame, text = " ", font = "Arial 16")
covid_news_label.pack(anchor = "w", side = "bottom")

covid_news_button = tk.Button(frame, text="Get Covid-19 News!", command = covid)
covid_news_button.pack(side ="left")
