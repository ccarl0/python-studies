...
def search():
    ...
    if weather:
        ...
        icon["fp"] = tk.PhotoImage(file=f"{weather[5]}.png")
...
def covid():
    ...
    city_dict = {"Afghanistan" : 0, "Albania" : 1, "Algeria" : 2, "Andorra" : 3, "Angola" : 4, "Antigua and Barbuda" : 5, "Argentina" : 6,"Armenia" : 7,
                 "Australia" : 8,"Austria" : 9, "Azerbaijan" : 10, "Bahamas" : 11, "Bahrain" : 12, "Bangladesh" : 13, "Barbados" : 14, "Belarus" : 15, "Belgium" : 16,
                 "Belize" : 17, "Benin" : 18,"Bhutan" : 19, "Bolivia" : 20, "Bosnia and Herzegovina" : 21, "Botswana," : 22, "Brazil" : 23, "Brunei" : 24,
                 "Bulgaria" : 25,"Burkina Faso" : 26,"Burundi" : 27, "Italy" : 82}
...
icon = Image.open(fp = "")
print("icon")
weather_icon_canvas = tk.Canvas(frame, bg = "#595856", width=100, height=100, bitmap = "")
weather_icon_canvas.pack()
#weather_icon_canvas.create_image(10, 10, image= "")
